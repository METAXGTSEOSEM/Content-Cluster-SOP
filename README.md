...
[![Industry](https://img.shields.io/badge/Applicable-B2B_Manufacturing_|_Industrial-FF4500?style=for-the-badge)](#)
[![Output](https://img.shields.io/badge/Output-High_Conversion_Assets-brightgreen?style=for-the-badge&logo=databricks)](#)
...
**目标**：将文章所有关键信息录入追踪表，形成可复查的内容资产记录。

使用 `templates/keyword-record-template.csv` 填写以下字段：
